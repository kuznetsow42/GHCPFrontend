...
export default function Messanger() {
  ...
  return (
    <section
      id="contact"
      class="relative w-full text-red-500 bg-[url('src/assets/bg/contacts.jpg')] bg-cover"
    >
      <h1 class="text-4xl p-4 font-bold tracking-wide text-white">Contacts</h1>
      ...
      <div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
        <div class="w-full md:w-1/2 p-5 md:px-0 mx-5">
          <div class="bg-gray-900 border border-red-500 w-full lg:w-1/2 h-full p-5 pt-8">
            ...
            <div class="flex flex-col gap-3">
              <a
                href="#"
                class="flex items-center hover:text-white hover:bg-red-500 p-2"
              >
                <svg
                  fill="currentColor"
                  class="w-6 h-6 m-2"
        ...
        <form
          action="#"
          class="w-full md:w-1/2 border border-red-500 p-6 bg-gray-900"
        >
